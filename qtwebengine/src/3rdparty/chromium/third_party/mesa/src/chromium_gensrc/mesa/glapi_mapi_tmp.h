...
GLAPI void APIENTRY GLAPI_PREFIX(ReadBufferNV)(GLenum mode);
...
GLAPI void APIENTRY GLAPI_PREFIX(BindVertexArrayOES)(GLuint array);
GLAPI void APIENTRY GLAPI_PREFIX(GenVertexArrays)(GLsizei n, GLuint *arrays);
GLAPI void APIENTRY GLAPI_PREFIX(GenVertexArraysOES)(GLsizei n, GLuint *arrays);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_623)(GLuint id, GLenum target);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_678)(GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_679)(GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_680)(GLuint program, GLenum pname, GLint value);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_723)(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_724)(const GLfloat *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_725)(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_726)(const GLint *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_727)(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_728)(const GLshort *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_729)(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_730)(const GLfixed *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_731)(GLenum type, GLsizei stride, const GLvoid *pointer);
GLbitfield APIENTRY GLAPI_PREFIX(_dispatch_stub_732)(GLfixed *mantissa, GLint *exponent);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_733)(GLclampf value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_734)(GLenum pattern);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_877)(GLenum face);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_878)(GLuint array);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_879)(GLsizei n, const GLuint *arrays);
GLAPI void APIENTRY GLAPI_PREFIX(DeleteVertexArrays)(GLsizei n, const GLuint *arrays);
GLAPI void APIENTRY GLAPI_PREFIX(DeleteVertexArraysOES)(GLsizei n, const GLuint *arrays);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_880)(GLsizei n, GLuint *arrays);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_881)(GLuint array);
GLAPI GLboolean APIENTRY GLAPI_PREFIX(IsVertexArray)(GLuint array);
GLAPI GLboolean APIENTRY GLAPI_PREFIX(IsVertexArrayOES)(GLuint array);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_890)(GLenum func, GLclampx ref);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_891)(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_892)(GLclampx depth);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_893)(GLenum plane, const GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_894)(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_895)(GLclampx zNear, GLclampx zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_896)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_897)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_898)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_899)(GLenum plane, GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_900)(GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_901)(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_902)(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_903)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_904)(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_905)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_906)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_907)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_908)(GLenum light, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_909)(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_910)(GLfixed width);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_911)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_912)(GLenum face, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_913)(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_914)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_915)(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_916)(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_917)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_918)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_919)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_920)(GLfixed size);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_921)(GLfixed factor, GLfixed units);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_922)(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_923)(GLclampx value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_924)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_925)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_926)(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_927)(GLenum coord, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_928)(GLenum coord, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_929)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_930)(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_931)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_932)(GLenum plane, const GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_933)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_934)(GLenum plane, GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_935)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_936)(GLclampd zmin, GLclampd zmax);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_937)(GLenum modeRGB, GLenum modeA);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_955)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_956)(GLenum target, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_957)(GLenum target, GLintptr offset, GLsizeiptr size);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1022)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1023)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1024)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1025)(GLuint id, GLenum pname, GLint64EXT *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1026)(GLuint id, GLenum pname, GLuint64EXT *params);
...
".globl "GLAPI_PREFIX_STR(ReadBufferNV)"\n"
".set "GLAPI_PREFIX_STR(ReadBufferNV)", "GLAPI_PREFIX_STR(ReadBuffer)"\n"
...
".globl "GLAPI_PREFIX_STR(BindVertexArrayOES)"\n"
".set "GLAPI_PREFIX_STR(BindVertexArrayOES)", "GLAPI_PREFIX_STR(BindVertexArray)"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GenVertexArrays))"\n"
"\t"STUB_ASM_CODE("583")"\n"

".globl "GLAPI_PREFIX_STR(GenVertexArraysOES)"\n"
".set "GLAPI_PREFIX_STR(GenVertexArraysOES)", "GLAPI_PREFIX_STR(GenVertexArrays)"\n"
...
STUB_ASM_ENTRY(GLAPI_PREFIX_STR(DeleteVertexArraysOES))"\n"
"\t"STUB_ASM_CODE("879")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(IsVertexArray))"\n"
"\t"STUB_ASM_CODE("881")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(IsVertexArrayOES))"\n"
"\t"STUB_ASM_CODE("881")"\n"
