...
public:
public:
   SkPdfFDFFieldDictionary* asFDFFieldDictionary() {return this;}
   const SkPdfFDFFieldDictionary* asFDFFieldDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Kids(SkPdfNativeDoc* doc);
  bool has_Kids() const;
  SkString T(SkPdfNativeDoc* doc);
  bool has_T() const;
  SkPdfNativeObject* V(SkPdfNativeDoc* doc);
  bool has_V() const;
  int64_t Ff(SkPdfNativeDoc* doc);
  bool has_Ff() const;
  int64_t SetFf(SkPdfNativeDoc* doc);
  bool has_SetFf() const;
  int64_t ClrFf(SkPdfNativeDoc* doc);
  bool has_ClrFf() const;
  int64_t F(SkPdfNativeDoc* doc);
  bool has_F() const;
  int64_t SetF(SkPdfNativeDoc* doc);
  bool has_SetF() const;
  int64_t ClrF(SkPdfNativeDoc* doc);
  bool has_ClrF() const;
  SkPdfDictionary* AP(SkPdfNativeDoc* doc);
  bool has_AP() const;
  SkPdfDictionary* APRef(SkPdfNativeDoc* doc);
  bool has_APRef() const;
  SkPdfDictionary* IF(SkPdfNativeDoc* doc);
  bool has_IF() const;
  SkPdfArray* Opt(SkPdfNativeDoc* doc);
  bool has_Opt() const;
  SkPdfDictionary* A(SkPdfNativeDoc* doc);
  bool has_A() const;
