...
public:
public:
   SkPdfFieldDictionary* asFieldDictionary() {return this;}
   const SkPdfFieldDictionary* asFieldDictionary() const {return this;}
...
public:
  ...
  SkString FT(SkPdfNativeDoc* doc);
  bool has_FT() const;
  ...
  bool has_T() const;
  SkString TU(SkPdfNativeDoc* doc);
  bool has_TU() const;
  SkString TM(SkPdfNativeDoc* doc);
  bool has_TM() const;
  int64_t Ff(SkPdfNativeDoc* doc);
  bool has_Ff() const;
  SkPdfNativeObject* V(SkPdfNativeDoc* doc);
  bool has_V() const;
  SkPdfNativeObject* DV(SkPdfNativeDoc* doc);
  bool has_DV() const;
