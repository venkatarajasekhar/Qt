...
public:
public:
   SkPdfEmbeddedFontStreamDictionary* asEmbeddedFontStreamDictionary() {return this;}
   const SkPdfEmbeddedFontStreamDictionary* asEmbeddedFontStreamDictionary() const {return this;}
...
public:
  ...
  int64_t Length1(SkPdfNativeDoc* doc);
  bool has_Length1() const;
  int64_t Length2(SkPdfNativeDoc* doc);
  bool has_Length2() const;
  int64_t Length3(SkPdfNativeDoc* doc);
