...
public:
public:
   SkPdfSoundObjectDictionary* asSoundObjectDictionary() {return this;}
   const SkPdfSoundObjectDictionary* asSoundObjectDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  double R(SkPdfNativeDoc* doc);
  bool has_R() const;
  int64_t C(SkPdfNativeDoc* doc);
  bool has_C() const;
  int64_t B(SkPdfNativeDoc* doc);
  bool has_B() const;
  SkString E(SkPdfNativeDoc* doc);
  bool has_E() const;
  SkString CO(SkPdfNativeDoc* doc);
  bool has_CO() const;
  SkPdfNativeObject* CP(SkPdfNativeDoc* doc);
  bool has_CP() const;
};
