...
public:
public:
   SkPdfRadioButtonFieldDictionary* asRadioButtonFieldDictionary() {return this;}
   const SkPdfRadioButtonFieldDictionary* asRadioButtonFieldDictionary() const {return this;}
