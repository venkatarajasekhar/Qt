...
public:
public:
   SkPdfOutlineItemDictionary* asOutlineItemDictionary() {return this;}
   const SkPdfOutlineItemDictionary* asOutlineItemDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* Prev(SkPdfNativeDoc* doc);
  bool has_Prev() const;
  SkPdfDictionary* Next(SkPdfNativeDoc* doc);
  bool has_Next() const;
  SkPdfDictionary* First(SkPdfNativeDoc* doc);
  bool has_First() const;
  SkPdfDictionary* Last(SkPdfNativeDoc* doc);
  bool has_Last() const;
  ...
  bool has_A() const;
  SkPdfDictionary* SE(SkPdfNativeDoc* doc);
  bool has_SE() const;
