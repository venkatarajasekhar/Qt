...
public:
public:
   SkPdfFileTrailerDictionary* asFileTrailerDictionary() {return this;}
   const SkPdfFileTrailerDictionary* asFileTrailerDictionary() const {return this;}
...
public:
  ...
  bool has_Size() const;
  int64_t Prev(SkPdfNativeDoc* doc);
  bool has_Prev() const;
  SkPdfDictionary* Root(SkPdfNativeDoc* doc);
  bool has_Root() const;
  SkPdfDictionary* Encrypt(SkPdfNativeDoc* doc);
  bool has_Encrypt() const;
  SkPdfDictionary* Info(SkPdfNativeDoc* doc);
  bool has_Info() const;
