...
public:
public:
   SkPdfMarkupAnnotationsDictionary* asMarkupAnnotationsDictionary() {return this;}
   const SkPdfMarkupAnnotationsDictionary* asMarkupAnnotationsDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* QuadPoints(SkPdfNativeDoc* doc);
