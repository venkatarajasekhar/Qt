...
public:
public:
   SkPdfCalrgbColorSpaceDictionary* asCalrgbColorSpaceDictionary() {return this;}
   const SkPdfCalrgbColorSpaceDictionary* asCalrgbColorSpaceDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* WhitePoint(SkPdfNativeDoc* doc);
  bool has_WhitePoint() const;
  SkPdfArray* BlackPoint(SkPdfNativeDoc* doc);
  bool has_BlackPoint() const;
  SkPdfArray* Gamma(SkPdfNativeDoc* doc);
