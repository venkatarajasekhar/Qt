...
public:
public:
   SkPdfFormFieldActionsDictionary* asFormFieldActionsDictionary() {return this;}
   const SkPdfFormFieldActionsDictionary* asFormFieldActionsDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* K(SkPdfNativeDoc* doc);
  bool has_K() const;
  SkPdfDictionary* F(SkPdfNativeDoc* doc);
  bool has_F() const;
  SkPdfDictionary* V(SkPdfNativeDoc* doc);
  bool has_V() const;
  SkPdfDictionary* C(SkPdfNativeDoc* doc);
  bool has_C() const;
};
