...
public:
public:
   SkPdfInteractiveFormDictionary* asInteractiveFormDictionary() {return this;}
   const SkPdfInteractiveFormDictionary* asInteractiveFormDictionary() const {return this;}
...
public:
  ...
  bool NeedAppearances(SkPdfNativeDoc* doc);
  bool has_NeedAppearances() const;
  int64_t SigFlags(SkPdfNativeDoc* doc);
  bool has_SigFlags() const;
  SkPdfArray* CO(SkPdfNativeDoc* doc);
  bool has_CO() const;
  SkPdfDictionary* DR(SkPdfNativeDoc* doc);
  bool has_DR() const;
  SkString DA(SkPdfNativeDoc* doc);
  bool has_DA() const;
  int64_t Q(SkPdfNativeDoc* doc);
  bool has_Q() const;
};
