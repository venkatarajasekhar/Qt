...
public:
public:
   SkPdfFunctionCommonDictionary* asFunctionCommonDictionary() {return this;}
   const SkPdfFunctionCommonDictionary* asFunctionCommonDictionary() const {return this;}
...
public:
  ...
  int64_t FunctionType(SkPdfNativeDoc* doc);
