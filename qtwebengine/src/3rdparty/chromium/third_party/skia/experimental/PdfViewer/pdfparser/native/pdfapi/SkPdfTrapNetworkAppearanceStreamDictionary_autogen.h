...
public:
public:
   SkPdfTrapNetworkAppearanceStreamDictionary* asTrapNetworkAppearanceStreamDictionary() {return this;}
   const SkPdfTrapNetworkAppearanceStreamDictionary* asTrapNetworkAppearanceStreamDictionary() const {return this;}
...
public:
  ...
  SkString PCM(SkPdfNativeDoc* doc);
  bool has_PCM() const;
  SkPdfArray* SeparationColorNames(SkPdfNativeDoc* doc);
  bool has_SeparationColorNames() const;
  SkPdfArray* TrapRegions(SkPdfNativeDoc* doc);
  bool has_TrapRegions() const;
  SkString TrapStyles(SkPdfNativeDoc* doc);
