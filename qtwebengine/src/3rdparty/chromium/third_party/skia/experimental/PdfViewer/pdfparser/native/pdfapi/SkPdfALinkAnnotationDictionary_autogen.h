...
public:
public:
   SkPdfALinkAnnotationDictionary* asALinkAnnotationDictionary() {return this;}
   const SkPdfALinkAnnotationDictionary* asALinkAnnotationDictionary() const {return this;}
...
public:
  ...
  bool has_H() const;
  SkPdfDictionary* PA(SkPdfNativeDoc* doc);
  bool has_PA() const;
};
