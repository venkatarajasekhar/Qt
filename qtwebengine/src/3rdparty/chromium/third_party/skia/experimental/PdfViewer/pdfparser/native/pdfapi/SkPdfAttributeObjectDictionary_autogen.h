...
public:
public:
   SkPdfAttributeObjectDictionary* asAttributeObjectDictionary() {return this;}
   const SkPdfAttributeObjectDictionary* asAttributeObjectDictionary() const {return this;}
