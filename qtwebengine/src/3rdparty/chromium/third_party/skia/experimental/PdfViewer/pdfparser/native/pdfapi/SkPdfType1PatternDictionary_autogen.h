...
public:
public:
   SkPdfType1PatternDictionary* asType1PatternDictionary() {return this;}
   const SkPdfType1PatternDictionary* asType1PatternDictionary() const {return this;}
...
public:
  ...
  int64_t PaintType(SkPdfNativeDoc* doc);
  bool has_PaintType() const;
  int64_t TilingType(SkPdfNativeDoc* doc);
  bool has_TilingType() const;
  SkRect BBox(SkPdfNativeDoc* doc);
  bool has_BBox() const;
  double XStep(SkPdfNativeDoc* doc);
  bool has_XStep() const;
  double YStep(SkPdfNativeDoc* doc);
  bool has_YStep() const;
