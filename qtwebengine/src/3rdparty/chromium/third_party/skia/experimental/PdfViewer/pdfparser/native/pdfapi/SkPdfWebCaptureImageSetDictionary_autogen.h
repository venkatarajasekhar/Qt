...
public:
public:
   SkPdfWebCaptureImageSetDictionary* asWebCaptureImageSetDictionary() {return this;}
   const SkPdfWebCaptureImageSetDictionary* asWebCaptureImageSetDictionary() const {return this;}
