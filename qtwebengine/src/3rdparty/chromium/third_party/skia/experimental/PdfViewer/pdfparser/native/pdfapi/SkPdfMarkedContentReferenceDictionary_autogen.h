...
public:
public:
   SkPdfMarkedContentReferenceDictionary* asMarkedContentReferenceDictionary() {return this;}
   const SkPdfMarkedContentReferenceDictionary* asMarkedContentReferenceDictionary() const {return this;}
...
public:
  ...
  bool has_Pg() const;
  SkPdfStream* Stm(SkPdfNativeDoc* doc);
  bool has_Stm() const;
  SkPdfNativeObject* StmOwn(SkPdfNativeDoc* doc);
  bool has_StmOwn() const;
  int64_t MCID(SkPdfNativeDoc* doc);
  bool has_MCID() const;
};
