...
public:
public:
   SkPdfPSXobjectDictionary* asPSXobjectDictionary() {return this;}
   const SkPdfPSXobjectDictionary* asPSXobjectDictionary() const {return this;}
...
public:
  ...
  SkPdfStream* Level1(SkPdfNativeDoc* doc);
