...
public:
public:
   SkPdfFileSpecificationDictionary* asFileSpecificationDictionary() {return this;}
   const SkPdfFileSpecificationDictionary* asFileSpecificationDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkString FS(SkPdfNativeDoc* doc);
  bool has_FS() const;
  SkString F(SkPdfNativeDoc* doc);
  bool has_F() const;
  SkString DOS(SkPdfNativeDoc* doc);
  bool has_DOS() const;
  SkString Mac(SkPdfNativeDoc* doc);
  bool has_Mac() const;
  SkString Unix(SkPdfNativeDoc* doc);
  bool has_Unix() const;
  SkPdfArray* ID(SkPdfNativeDoc* doc);
  bool has_ID() const;
  bool V(SkPdfNativeDoc* doc);
  bool has_V() const;
  SkPdfDictionary* EF(SkPdfNativeDoc* doc);
  bool has_EF() const;
  SkPdfDictionary* RF(SkPdfNativeDoc* doc);
  bool has_RF() const;
};
