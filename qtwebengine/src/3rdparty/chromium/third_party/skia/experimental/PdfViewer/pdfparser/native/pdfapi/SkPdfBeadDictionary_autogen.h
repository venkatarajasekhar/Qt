...
public:
public:
   SkPdfBeadDictionary* asBeadDictionary() {return this;}
   const SkPdfBeadDictionary* asBeadDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkPdfDictionary* T(SkPdfNativeDoc* doc);
  bool has_T() const;
  SkPdfDictionary* N(SkPdfNativeDoc* doc);
  bool has_N() const;
  SkPdfDictionary* V(SkPdfNativeDoc* doc);
  bool has_V() const;
  SkPdfDictionary* P(SkPdfNativeDoc* doc);
  bool has_P() const;
  SkRect R(SkPdfNativeDoc* doc);
  bool has_R() const;
};
