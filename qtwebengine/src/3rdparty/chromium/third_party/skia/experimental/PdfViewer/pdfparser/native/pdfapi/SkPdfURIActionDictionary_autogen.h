...
public:
public:
   SkPdfURIActionDictionary* asURIActionDictionary() {return this;}
   const SkPdfURIActionDictionary* asURIActionDictionary() const {return this;}
...
public:
  ...
  bool has_S() const;
  SkString URI(SkPdfNativeDoc* doc);
  bool has_URI() const;
  bool IsMap(SkPdfNativeDoc* doc);
