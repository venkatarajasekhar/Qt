...
public:
public:
   SkPdfGroupAttributesDictionary* asGroupAttributesDictionary() {return this;}
   const SkPdfGroupAttributesDictionary* asGroupAttributesDictionary() const {return this;}
