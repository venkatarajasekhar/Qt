...
public:
public:
   SkPdfFDFCatalogDictionary* asFDFCatalogDictionary() {return this;}
   const SkPdfFDFCatalogDictionary* asFDFCatalogDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* FDF(SkPdfNativeDoc* doc);
  bool has_FDF() const;
};
