...
public:
public:
   SkPdfRemoteGoToActionDictionary* asRemoteGoToActionDictionary() {return this;}
   const SkPdfRemoteGoToActionDictionary* asRemoteGoToActionDictionary() const {return this;}
