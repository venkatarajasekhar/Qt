...
public:
public:
   SkPdfMovieActionDictionary* asMovieActionDictionary() {return this;}
   const SkPdfMovieActionDictionary* asMovieActionDictionary() const {return this;}
...
public:
  ...
  bool has_S() const;
  SkPdfDictionary* Annot(SkPdfNativeDoc* doc);
  bool has_Annot() const;
  SkString T(SkPdfNativeDoc* doc);
  bool has_T() const;
  SkString Operation(SkPdfNativeDoc* doc);
