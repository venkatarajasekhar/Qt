...
public:
public:
   SkPdfDeviceNColorSpaceDictionary* asDeviceNColorSpaceDictionary() {return this;}
   const SkPdfDeviceNColorSpaceDictionary* asDeviceNColorSpaceDictionary() const {return this;}
