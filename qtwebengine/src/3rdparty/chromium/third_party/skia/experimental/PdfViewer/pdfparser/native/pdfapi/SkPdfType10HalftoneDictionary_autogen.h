...
public:
public:
   SkPdfType10HalftoneDictionary* asType10HalftoneDictionary() {return this;}
   const SkPdfType10HalftoneDictionary* asType10HalftoneDictionary() const {return this;}
