...
public:
public:
   SkPdfListAttributeDictionary* asListAttributeDictionary() {return this;}
   const SkPdfListAttributeDictionary* asListAttributeDictionary() const {return this;}
...
public:
  ...
  SkString ListNumbering(SkPdfNativeDoc* doc);
