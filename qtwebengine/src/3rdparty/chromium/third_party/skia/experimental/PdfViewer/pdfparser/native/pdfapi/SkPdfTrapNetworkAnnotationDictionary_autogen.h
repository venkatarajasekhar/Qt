...
public:
public:
   SkPdfTrapNetworkAnnotationDictionary* asTrapNetworkAnnotationDictionary() {return this;}
   const SkPdfTrapNetworkAnnotationDictionary* asTrapNetworkAnnotationDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Version(SkPdfNativeDoc* doc);
  bool has_Version() const;
  SkPdfArray* AnnotStates(SkPdfNativeDoc* doc);
  bool has_AnnotStates() const;
  SkPdfArray* FontFauxing(SkPdfNativeDoc* doc);
