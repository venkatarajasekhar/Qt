...
public:
public:
   SkPdfStructureTreeRootDictionary* asStructureTreeRootDictionary() {return this;}
   const SkPdfStructureTreeRootDictionary* asStructureTreeRootDictionary() const {return this;}
...
public:
  ...
  int64_t ParentTreeNextKey(SkPdfNativeDoc* doc);
  bool has_ParentTreeNextKey() const;
  SkPdfDictionary* RoleMap(SkPdfNativeDoc* doc);
  bool has_RoleMap() const;
  SkPdfDictionary* ClassMap(SkPdfNativeDoc* doc);
