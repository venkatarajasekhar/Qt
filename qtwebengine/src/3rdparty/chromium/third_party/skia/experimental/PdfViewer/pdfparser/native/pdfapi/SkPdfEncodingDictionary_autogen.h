...
public:
public:
   SkPdfEncodingDictionary* asEncodingDictionary() {return this;}
   const SkPdfEncodingDictionary* asEncodingDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkString BaseEncoding(SkPdfNativeDoc* doc);
  bool has_BaseEncoding() const;
  SkPdfArray* Differences(SkPdfNativeDoc* doc);
