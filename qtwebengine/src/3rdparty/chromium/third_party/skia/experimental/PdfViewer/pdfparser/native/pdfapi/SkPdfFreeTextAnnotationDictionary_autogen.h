...
public:
public:
   SkPdfFreeTextAnnotationDictionary* asFreeTextAnnotationDictionary() {return this;}
   const SkPdfFreeTextAnnotationDictionary* asFreeTextAnnotationDictionary() const {return this;}
