...
public:
public:
   SkPdfIccProfileStreamDictionary* asIccProfileStreamDictionary() {return this;}
   const SkPdfIccProfileStreamDictionary* asIccProfileStreamDictionary() const {return this;}
