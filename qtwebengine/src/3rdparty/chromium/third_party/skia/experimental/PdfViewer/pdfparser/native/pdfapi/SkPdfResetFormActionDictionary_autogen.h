...
public:
public:
   SkPdfResetFormActionDictionary* asResetFormActionDictionary() {return this;}
   const SkPdfResetFormActionDictionary* asResetFormActionDictionary() const {return this;}
