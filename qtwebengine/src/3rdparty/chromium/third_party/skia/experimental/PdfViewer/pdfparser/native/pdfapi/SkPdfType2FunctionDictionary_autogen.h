...
public:
public:
   SkPdfType2FunctionDictionary* asType2FunctionDictionary() {return this;}
   const SkPdfType2FunctionDictionary* asType2FunctionDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* C0(SkPdfNativeDoc* doc);
  bool has_C0() const;
  SkPdfArray* C1(SkPdfNativeDoc* doc);
  bool has_C1() const;
  double N(SkPdfNativeDoc* doc);
  bool has_N() const;
};
