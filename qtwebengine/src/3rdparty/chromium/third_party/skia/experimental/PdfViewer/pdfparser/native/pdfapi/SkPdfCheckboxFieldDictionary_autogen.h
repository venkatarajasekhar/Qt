...
public:
public:
   SkPdfCheckboxFieldDictionary* asCheckboxFieldDictionary() {return this;}
   const SkPdfCheckboxFieldDictionary* asCheckboxFieldDictionary() const {return this;}
...
public:
  ...
  SkString Opt(SkPdfNativeDoc* doc);
  bool has_Opt() const;
};
