...
public:
public:
   SkPdfCcittfaxdecodeFilterDictionary* asCcittfaxdecodeFilterDictionary() {return this;}
   const SkPdfCcittfaxdecodeFilterDictionary* asCcittfaxdecodeFilterDictionary() const {return this;}
...
public:
  ...
  int64_t K(SkPdfNativeDoc* doc);
  bool has_K() const;
  bool EndOfLine(SkPdfNativeDoc* doc);
  bool has_EndOfLine() const;
  bool EncodedByteAlign(SkPdfNativeDoc* doc);
  bool has_EncodedByteAlign() const;
  int64_t Columns(SkPdfNativeDoc* doc);
  bool has_Columns() const;
  int64_t Rows(SkPdfNativeDoc* doc);
  bool has_Rows() const;
  bool EndOfBlock(SkPdfNativeDoc* doc);
  bool has_EndOfBlock() const;
  bool BlackIs1(SkPdfNativeDoc* doc);
  bool has_BlackIs1() const;
  int64_t DamagedRowsBeforeError(SkPdfNativeDoc* doc);
