...
public:
public:
   SkPdfType0FunctionDictionary* asType0FunctionDictionary() {return this;}
   const SkPdfType0FunctionDictionary* asType0FunctionDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Size(SkPdfNativeDoc* doc);
  bool has_Size() const;
  int64_t BitsPerSample(SkPdfNativeDoc* doc);
  bool has_BitsPerSample() const;
  int64_t Order(SkPdfNativeDoc* doc);
  bool has_Order() const;
  SkPdfArray* Encode(SkPdfNativeDoc* doc);
