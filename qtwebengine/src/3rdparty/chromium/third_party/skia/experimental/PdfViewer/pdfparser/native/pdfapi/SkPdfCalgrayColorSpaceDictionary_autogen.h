...
public:
public:
   SkPdfCalgrayColorSpaceDictionary* asCalgrayColorSpaceDictionary() {return this;}
   const SkPdfCalgrayColorSpaceDictionary* asCalgrayColorSpaceDictionary() const {return this;}
...
public:
  ...
  double Gamma(SkPdfNativeDoc* doc);
