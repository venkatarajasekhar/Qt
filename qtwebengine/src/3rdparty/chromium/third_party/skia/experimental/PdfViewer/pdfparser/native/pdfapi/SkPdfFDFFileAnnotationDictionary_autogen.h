...
public:
public:
   SkPdfFDFFileAnnotationDictionary* asFDFFileAnnotationDictionary() {return this;}
   const SkPdfFDFFileAnnotationDictionary* asFDFFileAnnotationDictionary() const {return this;}
...
public:
  ...
  int64_t Page(SkPdfNativeDoc* doc);
  bool has_Page() const;
};
