...
public:
public:
   SkPdfType5HalftoneDictionary* asType5HalftoneDictionary() {return this;}
   const SkPdfType5HalftoneDictionary* asType5HalftoneDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  double HalftoneType(SkPdfNativeDoc* doc);
