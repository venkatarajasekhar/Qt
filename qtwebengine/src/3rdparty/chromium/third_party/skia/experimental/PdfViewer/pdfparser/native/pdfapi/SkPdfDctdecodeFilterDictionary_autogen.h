...
public:
public:
   SkPdfDctdecodeFilterDictionary* asDctdecodeFilterDictionary() {return this;}
   const SkPdfDctdecodeFilterDictionary* asDctdecodeFilterDictionary() const {return this;}
...
public:
  ...
  int64_t ColorTransform(SkPdfNativeDoc* doc);
