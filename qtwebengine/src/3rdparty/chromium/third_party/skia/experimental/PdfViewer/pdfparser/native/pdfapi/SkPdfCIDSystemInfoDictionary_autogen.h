...
public:
public:
   SkPdfCIDSystemInfoDictionary* asCIDSystemInfoDictionary() {return this;}
   const SkPdfCIDSystemInfoDictionary* asCIDSystemInfoDictionary() const {return this;}
...
public:
  ...
  SkString Registry(SkPdfNativeDoc* doc);
  bool has_Registry() const;
  SkString Ordering(SkPdfNativeDoc* doc);
  bool has_Ordering() const;
  int64_t Supplement(SkPdfNativeDoc* doc);
