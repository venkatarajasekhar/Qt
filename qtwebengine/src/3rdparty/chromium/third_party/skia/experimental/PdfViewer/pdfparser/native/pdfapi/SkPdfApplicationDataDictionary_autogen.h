...
public:
public:
   SkPdfApplicationDataDictionary* asApplicationDataDictionary() {return this;}
   const SkPdfApplicationDataDictionary* asApplicationDataDictionary() const {return this;}
...
public:
  ...
  SkPdfNativeObject* Private(SkPdfNativeDoc* doc);
