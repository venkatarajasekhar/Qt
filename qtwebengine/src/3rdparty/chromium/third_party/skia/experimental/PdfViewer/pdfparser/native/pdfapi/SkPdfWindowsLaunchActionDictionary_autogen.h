...
public:
public:
   SkPdfWindowsLaunchActionDictionary* asWindowsLaunchActionDictionary() {return this;}
   const SkPdfWindowsLaunchActionDictionary* asWindowsLaunchActionDictionary() const {return this;}
...
public:
  ...
  bool has_F() const;
  SkString D(SkPdfNativeDoc* doc);
  bool has_D() const;
  SkString O(SkPdfNativeDoc* doc);
  bool has_O() const;
  SkString P(SkPdfNativeDoc* doc);
  bool has_P() const;
};
