...
public:
public:
   SkPdfPopUpAnnotationDictionary* asPopUpAnnotationDictionary() {return this;}
   const SkPdfPopUpAnnotationDictionary* asPopUpAnnotationDictionary() const {return this;}
