...
public:
public:
   SkPdfNameTreeNodeDictionary* asNameTreeNodeDictionary() {return this;}
   const SkPdfNameTreeNodeDictionary* asNameTreeNodeDictionary() const {return this;}
...
public:
  ...
  bool has_Kids() const;
  SkPdfArray* Names(SkPdfNativeDoc* doc);
