...
public:
public:
   SkPdfJbig2DecodeFilterDictionary* asJbig2DecodeFilterDictionary() {return this;}
   const SkPdfJbig2DecodeFilterDictionary* asJbig2DecodeFilterDictionary() const {return this;}
...
public:
  ...
  SkPdfStream* JBIG2Globals(SkPdfNativeDoc* doc);
