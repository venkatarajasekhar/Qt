...
public:
public:
   SkPdfChoiceFieldDictionary* asChoiceFieldDictionary() {return this;}
   const SkPdfChoiceFieldDictionary* asChoiceFieldDictionary() const {return this;}
...
public:
  ...
  bool has_Opt() const;
  int64_t TI(SkPdfNativeDoc* doc);
  bool has_TI() const;
  SkPdfArray* I(SkPdfNativeDoc* doc);
  bool has_I() const;
};
