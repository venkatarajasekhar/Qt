...
public:
public:
   SkPdfSubmitFormActionDictionary* asSubmitFormActionDictionary() {return this;}
   const SkPdfSubmitFormActionDictionary* asSubmitFormActionDictionary() const {return this;}
