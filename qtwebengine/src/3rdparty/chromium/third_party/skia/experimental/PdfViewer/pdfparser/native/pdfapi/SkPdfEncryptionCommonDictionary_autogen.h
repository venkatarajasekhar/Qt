...
public:
public:
   SkPdfEncryptionCommonDictionary* asEncryptionCommonDictionary() {return this;}
   const SkPdfEncryptionCommonDictionary* asEncryptionCommonDictionary() const {return this;}
