...
public:
public:
   SkPdfCatalogDictionary* asCatalogDictionary() {return this;}
   const SkPdfCatalogDictionary* asCatalogDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkString Version(SkPdfNativeDoc* doc);
  ...
  SkPdfDictionary* Names(SkPdfNativeDoc* doc);
  bool has_Names() const;
  SkPdfDictionary* Dests(SkPdfNativeDoc* doc);
  bool has_Dests() const;
  SkPdfDictionary* ViewerPreferences(SkPdfNativeDoc* doc);
  bool has_ViewerPreferences() const;
  SkString PageLayout(SkPdfNativeDoc* doc);
  bool has_PageLayout() const;
  SkString PageMode(SkPdfNativeDoc* doc);
  bool has_PageMode() const;
  SkPdfDictionary* Outlines(SkPdfNativeDoc* doc);
  ...
  SkPdfDictionary* AA(SkPdfNativeDoc* doc);
  bool has_AA() const;
  SkPdfDictionary* URI(SkPdfNativeDoc* doc);
  bool has_URI() const;
  SkPdfDictionary* AcroForm(SkPdfNativeDoc* doc);
  bool has_AcroForm() const;
  SkPdfStream* Metadata(SkPdfNativeDoc* doc);
  bool has_Metadata() const;
  SkPdfDictionary* StructTreeRoot(SkPdfNativeDoc* doc);
  bool has_StructTreeRoot() const;
  SkPdfDictionary* MarkInfo(SkPdfNativeDoc* doc);
  bool has_MarkInfo() const;
  SkString Lang(SkPdfNativeDoc* doc);
  bool has_Lang() const;
  SkPdfDictionary* SpiderInfo(SkPdfNativeDoc* doc);
  bool has_SpiderInfo() const;
  SkPdfArray* OutputIntents(SkPdfNativeDoc* doc);
