...
public:
public:
   SkPdfLzwdecodeAndFlatedecodeFiltersDictionary* asLzwdecodeAndFlatedecodeFiltersDictionary() {return this;}
   const SkPdfLzwdecodeAndFlatedecodeFiltersDictionary* asLzwdecodeAndFlatedecodeFiltersDictionary() const {return this;}
...
public:
  ...
  int64_t Predictor(SkPdfNativeDoc* doc);
  bool has_Predictor() const;
  int64_t Colors(SkPdfNativeDoc* doc);
  ...
  int64_t EarlyChange(SkPdfNativeDoc* doc);
