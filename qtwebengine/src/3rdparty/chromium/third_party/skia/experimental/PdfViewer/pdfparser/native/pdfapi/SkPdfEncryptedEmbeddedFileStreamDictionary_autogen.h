...
public:
public:
   SkPdfEncryptedEmbeddedFileStreamDictionary* asEncryptedEmbeddedFileStreamDictionary() {return this;}
   const SkPdfEncryptedEmbeddedFileStreamDictionary* asEncryptedEmbeddedFileStreamDictionary() const {return this;}
...
public:
  ...
  int64_t EncryptionRevision(SkPdfNativeDoc* doc);
