...
public:
public:
   SkPdfIconFitDictionary* asIconFitDictionary() {return this;}
   const SkPdfIconFitDictionary* asIconFitDictionary() const {return this;}
...
public:
  ...
  SkString SW(SkPdfNativeDoc* doc);
  bool has_SW() const;
  SkString S(SkPdfNativeDoc* doc);
  bool has_S() const;
  SkPdfArray* A(SkPdfNativeDoc* doc);
  bool has_A() const;
};
