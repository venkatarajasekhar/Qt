...
public:
public:
   SkPdfWebCaptureInformationDictionary* asWebCaptureInformationDictionary() {return this;}
   const SkPdfWebCaptureInformationDictionary* asWebCaptureInformationDictionary() const {return this;}
