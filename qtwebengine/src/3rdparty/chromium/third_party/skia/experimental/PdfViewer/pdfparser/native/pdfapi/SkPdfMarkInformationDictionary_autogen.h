...
public:
public:
   SkPdfMarkInformationDictionary* asMarkInformationDictionary() {return this;}
   const SkPdfMarkInformationDictionary* asMarkInformationDictionary() const {return this;}
...
public:
  ...
  bool Marked(SkPdfNativeDoc* doc);
