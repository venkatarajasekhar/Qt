...
public:
public:
   SkPdfJavascriptDictionary* asJavascriptDictionary() {return this;}
   const SkPdfJavascriptDictionary* asJavascriptDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Doc(SkPdfNativeDoc* doc);
  bool has_Doc() const;
};
