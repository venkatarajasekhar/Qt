...
public:
public:
   SkPdfFontDescriptorDictionary* asFontDescriptorDictionary() {return this;}
   const SkPdfFontDescriptorDictionary* asFontDescriptorDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkString FontName(SkPdfNativeDoc* doc);
  bool has_FontName() const;
  int64_t Flags(SkPdfNativeDoc* doc);
  bool has_Flags() const;
  SkRect FontBBox(SkPdfNativeDoc* doc);
  bool has_FontBBox() const;
  double ItalicAngle(SkPdfNativeDoc* doc);
  bool has_ItalicAngle() const;
  double Ascent(SkPdfNativeDoc* doc);
  bool has_Ascent() const;
  double Descent(SkPdfNativeDoc* doc);
  bool has_Descent() const;
  double Leading(SkPdfNativeDoc* doc);
  bool has_Leading() const;
  double CapHeight(SkPdfNativeDoc* doc);
  bool has_CapHeight() const;
  double XHeight(SkPdfNativeDoc* doc);
  bool has_XHeight() const;
  double StemV(SkPdfNativeDoc* doc);
  bool has_StemV() const;
  double StemH(SkPdfNativeDoc* doc);
  bool has_StemH() const;
  double AvgWidth(SkPdfNativeDoc* doc);
  bool has_AvgWidth() const;
  double MaxWidth(SkPdfNativeDoc* doc);
  bool has_MaxWidth() const;
  double MissingWidth(SkPdfNativeDoc* doc);
  bool has_MissingWidth() const;
  SkPdfStream* FontFile(SkPdfNativeDoc* doc);
  bool has_FontFile() const;
  SkPdfStream* FontFile2(SkPdfNativeDoc* doc);
  bool has_FontFile2() const;
  SkPdfStream* FontFile3(SkPdfNativeDoc* doc);
  bool has_FontFile3() const;
  SkString CharSet(SkPdfNativeDoc* doc);
