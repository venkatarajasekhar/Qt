...
public:
public:
   SkPdfAppearanceCharacteristicsDictionary* asAppearanceCharacteristicsDictionary() {return this;}
   const SkPdfAppearanceCharacteristicsDictionary* asAppearanceCharacteristicsDictionary() const {return this;}
...
public:
  ...
  int64_t R(SkPdfNativeDoc* doc);
  bool has_R() const;
  SkPdfArray* BC(SkPdfNativeDoc* doc);
  bool has_BC() const;
  SkPdfArray* BG(SkPdfNativeDoc* doc);
  bool has_BG() const;
  SkString CA(SkPdfNativeDoc* doc);
  bool has_CA() const;
  SkString RC(SkPdfNativeDoc* doc);
  bool has_RC() const;
  SkString AC(SkPdfNativeDoc* doc);
  bool has_AC() const;
  SkPdfStream* I(SkPdfNativeDoc* doc);
  bool has_I() const;
  SkPdfStream* RI(SkPdfNativeDoc* doc);
  bool has_RI() const;
  SkPdfStream* IX(SkPdfNativeDoc* doc);
  bool has_IX() const;
  SkPdfDictionary* IF(SkPdfNativeDoc* doc);
  bool has_IF() const;
  int64_t TP(SkPdfNativeDoc* doc);
  bool has_TP() const;
};
