...
public:
public:
   SkPdfTransitionDictionary* asTransitionDictionary() {return this;}
   const SkPdfTransitionDictionary* asTransitionDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  double D(SkPdfNativeDoc* doc);
  bool has_D() const;
  SkString S(SkPdfNativeDoc* doc);
  bool has_S() const;
  SkString Dm(SkPdfNativeDoc* doc);
  bool has_Dm() const;
  SkString M(SkPdfNativeDoc* doc);
  bool has_M() const;
  double Di(SkPdfNativeDoc* doc);
  bool has_Di() const;
};
