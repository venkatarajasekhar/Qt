...
public:
public:
   SkPdfPDF_XOutputIntentDictionary* asPDF_XOutputIntentDictionary() {return this;}
   const SkPdfPDF_XOutputIntentDictionary* asPDF_XOutputIntentDictionary() const {return this;}
...
public:
  ...
  bool has_S() const;
  SkString OutputCondition(SkPdfNativeDoc* doc);
  bool has_OutputCondition() const;
  SkString OutputConditionIdentifier(SkPdfNativeDoc* doc);
  bool has_OutputConditionIdentifier() const;
  SkString RegistryName(SkPdfNativeDoc* doc);
  bool has_RegistryName() const;
  SkString Info(SkPdfNativeDoc* doc);
  bool has_Info() const;
  SkPdfStream* DestOutputProfile(SkPdfNativeDoc* doc);
