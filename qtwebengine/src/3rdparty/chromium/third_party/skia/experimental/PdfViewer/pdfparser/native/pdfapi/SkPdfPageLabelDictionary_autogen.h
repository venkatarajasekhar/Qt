...
public:
public:
   SkPdfPageLabelDictionary* asPageLabelDictionary() {return this;}
   const SkPdfPageLabelDictionary* asPageLabelDictionary() const {return this;}
