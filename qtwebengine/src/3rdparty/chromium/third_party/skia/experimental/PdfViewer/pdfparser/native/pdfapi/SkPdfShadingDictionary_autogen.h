...
public:
public:
   SkPdfShadingDictionary* asShadingDictionary() {return this;}
   const SkPdfShadingDictionary* asShadingDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Background(SkPdfNativeDoc* doc);
  bool has_Background() const;
  SkRect BBox(SkPdfNativeDoc* doc);
  bool has_BBox() const;
  bool AntiAlias(SkPdfNativeDoc* doc);
