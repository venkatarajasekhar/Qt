...
public:
public:
   SkPdfImportDataActionDictionary* asImportDataActionDictionary() {return this;}
   const SkPdfImportDataActionDictionary* asImportDataActionDictionary() const {return this;}
