...
public:
public:
   SkPdfSourceInformationDictionary* asSourceInformationDictionary() {return this;}
   const SkPdfSourceInformationDictionary* asSourceInformationDictionary() const {return this;}
...
public:
  ...
  bool has_AU() const;
  SkPdfDate TS(SkPdfNativeDoc* doc);
  bool has_TS() const;
  SkPdfDate E(SkPdfNativeDoc* doc);
  bool has_E() const;
  int64_t S(SkPdfNativeDoc* doc);
  bool has_S() const;
