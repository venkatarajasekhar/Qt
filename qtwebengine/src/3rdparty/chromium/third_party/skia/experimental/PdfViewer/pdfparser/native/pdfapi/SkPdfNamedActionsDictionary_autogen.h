...
public:
public:
   SkPdfNamedActionsDictionary* asNamedActionsDictionary() {return this;}
   const SkPdfNamedActionsDictionary* asNamedActionsDictionary() const {return this;}
