...
public:
public:
   SkPdfVariableTextFieldDictionary* asVariableTextFieldDictionary() {return this;}
   const SkPdfVariableTextFieldDictionary* asVariableTextFieldDictionary() const {return this;}
