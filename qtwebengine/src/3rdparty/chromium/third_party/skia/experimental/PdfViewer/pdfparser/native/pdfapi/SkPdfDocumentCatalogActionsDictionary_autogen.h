...
public:
public:
   SkPdfDocumentCatalogActionsDictionary* asDocumentCatalogActionsDictionary() {return this;}
   const SkPdfDocumentCatalogActionsDictionary* asDocumentCatalogActionsDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* DC(SkPdfNativeDoc* doc);
  bool has_DC() const;
  SkPdfDictionary* WS(SkPdfNativeDoc* doc);
  bool has_WS() const;
  SkPdfDictionary* DS(SkPdfNativeDoc* doc);
  bool has_DS() const;
  SkPdfDictionary* WP(SkPdfNativeDoc* doc);
  bool has_WP() const;
  SkPdfDictionary* DP(SkPdfNativeDoc* doc);
  bool has_DP() const;
};
