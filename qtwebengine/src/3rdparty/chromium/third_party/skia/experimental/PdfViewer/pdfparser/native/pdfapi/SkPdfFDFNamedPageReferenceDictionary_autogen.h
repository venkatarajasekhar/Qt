...
public:
public:
   SkPdfFDFNamedPageReferenceDictionary* asFDFNamedPageReferenceDictionary() {return this;}
   const SkPdfFDFNamedPageReferenceDictionary* asFDFNamedPageReferenceDictionary() const {return this;}
