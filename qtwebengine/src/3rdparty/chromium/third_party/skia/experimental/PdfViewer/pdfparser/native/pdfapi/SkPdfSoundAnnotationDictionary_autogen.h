...
public:
public:
   SkPdfSoundAnnotationDictionary* asSoundAnnotationDictionary() {return this;}
   const SkPdfSoundAnnotationDictionary* asSoundAnnotationDictionary() const {return this;}
