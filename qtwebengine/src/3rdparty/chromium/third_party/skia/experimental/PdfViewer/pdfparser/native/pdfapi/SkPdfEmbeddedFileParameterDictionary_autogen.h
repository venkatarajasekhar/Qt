...
public:
public:
   SkPdfEmbeddedFileParameterDictionary* asEmbeddedFileParameterDictionary() {return this;}
   const SkPdfEmbeddedFileParameterDictionary* asEmbeddedFileParameterDictionary() const {return this;}
...
public:
  ...
  int64_t Size(SkPdfNativeDoc* doc);
  bool has_Size() const;
  ...
  SkPdfDictionary* Mac(SkPdfNativeDoc* doc);
  bool has_Mac() const;
  SkString CheckSum(SkPdfNativeDoc* doc);
