...
public:
public:
   SkPdfTextFieldDictionary* asTextFieldDictionary() {return this;}
   const SkPdfTextFieldDictionary* asTextFieldDictionary() const {return this;}
...
public:
  ...
  int64_t MaxLen(SkPdfNativeDoc* doc);
