...
public:
public:
   SkPdfBoxColorInformationDictionary* asBoxColorInformationDictionary() {return this;}
   const SkPdfBoxColorInformationDictionary* asBoxColorInformationDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* CropBox(SkPdfNativeDoc* doc);
  bool has_CropBox() const;
  SkPdfDictionary* BleedBox(SkPdfNativeDoc* doc);
  bool has_BleedBox() const;
  SkPdfDictionary* TrimBox(SkPdfNativeDoc* doc);
  bool has_TrimBox() const;
  SkPdfDictionary* ArtBox(SkPdfNativeDoc* doc);
