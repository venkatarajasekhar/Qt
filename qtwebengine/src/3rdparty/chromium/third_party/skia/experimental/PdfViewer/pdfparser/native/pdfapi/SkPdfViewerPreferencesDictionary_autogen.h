...
public:
public:
   SkPdfViewerPreferencesDictionary* asViewerPreferencesDictionary() {return this;}
   const SkPdfViewerPreferencesDictionary* asViewerPreferencesDictionary() const {return this;}
...
public:
  ...
  bool HideToolbar(SkPdfNativeDoc* doc);
  bool has_HideToolbar() const;
  bool HideMenubar(SkPdfNativeDoc* doc);
  bool has_HideMenubar() const;
  bool HideWindowUI(SkPdfNativeDoc* doc);
  bool has_HideWindowUI() const;
  bool FitWindow(SkPdfNativeDoc* doc);
  bool has_FitWindow() const;
  bool CenterWindow(SkPdfNativeDoc* doc);
  bool has_CenterWindow() const;
  bool DisplayDocTitle(SkPdfNativeDoc* doc);
  bool has_DisplayDocTitle() const;
  SkString NonFullScreenPageMode(SkPdfNativeDoc* doc);
  bool has_NonFullScreenPageMode() const;
  SkString Direction(SkPdfNativeDoc* doc);
  bool has_Direction() const;
  SkString ViewArea(SkPdfNativeDoc* doc);
  bool has_ViewArea() const;
  SkString ViewClip(SkPdfNativeDoc* doc);
  bool has_ViewClip() const;
  SkString PrintArea(SkPdfNativeDoc* doc);
  bool has_PrintArea() const;
  SkString PrintClip(SkPdfNativeDoc* doc);
