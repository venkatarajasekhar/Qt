...
public:
public:
   SkPdfRubberStampAnnotationDictionary* asRubberStampAnnotationDictionary() {return this;}
   const SkPdfRubberStampAnnotationDictionary* asRubberStampAnnotationDictionary() const {return this;}
