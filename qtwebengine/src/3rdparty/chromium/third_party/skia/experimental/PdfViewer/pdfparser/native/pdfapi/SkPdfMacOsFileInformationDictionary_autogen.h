...
public:
public:
   SkPdfMacOsFileInformationDictionary* asMacOsFileInformationDictionary() {return this;}
   const SkPdfMacOsFileInformationDictionary* asMacOsFileInformationDictionary() const {return this;}
...
public:
  ...
  SkPdfStream* ResFork(SkPdfNativeDoc* doc);
