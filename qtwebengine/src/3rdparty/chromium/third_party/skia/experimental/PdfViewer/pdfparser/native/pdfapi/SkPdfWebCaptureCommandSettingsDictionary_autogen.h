...
public:
public:
   SkPdfWebCaptureCommandSettingsDictionary* asWebCaptureCommandSettingsDictionary() {return this;}
   const SkPdfWebCaptureCommandSettingsDictionary* asWebCaptureCommandSettingsDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* G(SkPdfNativeDoc* doc);
  bool has_G() const;
