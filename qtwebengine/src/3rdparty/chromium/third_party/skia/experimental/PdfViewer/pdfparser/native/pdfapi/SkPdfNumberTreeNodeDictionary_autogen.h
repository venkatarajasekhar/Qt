...
public:
public:
   SkPdfNumberTreeNodeDictionary* asNumberTreeNodeDictionary() {return this;}
   const SkPdfNumberTreeNodeDictionary* asNumberTreeNodeDictionary() const {return this;}
...
public:
  ...
  bool has_Kids() const;
  SkPdfArray* Nums(SkPdfNativeDoc* doc);
  bool has_Nums() const;
  SkPdfArray* Limits(SkPdfNativeDoc* doc);
