...
public:
public:
   SkPdfWebCaptureCommandDictionary* asWebCaptureCommandDictionary() {return this;}
   const SkPdfWebCaptureCommandDictionary* asWebCaptureCommandDictionary() const {return this;}
...
public:
  ...
  SkString URL(SkPdfNativeDoc* doc);
  bool has_URL() const;
  int64_t L(SkPdfNativeDoc* doc);
  bool has_L() const;
  ...
  bool has_P() const;
  SkString CT(SkPdfNativeDoc* doc);
  bool has_CT() const;
  SkString H(SkPdfNativeDoc* doc);
  bool has_H() const;
  SkPdfDictionary* S(SkPdfNativeDoc* doc);
  bool has_S() const;
};
