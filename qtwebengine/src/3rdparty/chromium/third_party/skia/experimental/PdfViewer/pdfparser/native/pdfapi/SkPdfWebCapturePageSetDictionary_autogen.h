...
public:
public:
   SkPdfWebCapturePageSetDictionary* asWebCapturePageSetDictionary() {return this;}
   const SkPdfWebCapturePageSetDictionary* asWebCapturePageSetDictionary() const {return this;}
...
public:
  ...
  bool has_T() const;
  SkString TID(SkPdfNativeDoc* doc);
  bool has_TID() const;
};
