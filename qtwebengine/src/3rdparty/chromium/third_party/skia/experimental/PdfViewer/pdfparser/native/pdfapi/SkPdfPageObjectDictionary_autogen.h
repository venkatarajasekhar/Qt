...
public:
public:
   SkPdfPageObjectDictionary* asPageObjectDictionary() {return this;}
   const SkPdfPageObjectDictionary* asPageObjectDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkPdfDictionary* Parent(SkPdfNativeDoc* doc);
  ...
  SkRect MediaBox(SkPdfNativeDoc* doc);
  bool has_MediaBox() const;
  SkRect CropBox(SkPdfNativeDoc* doc);
  bool has_CropBox() const;
  SkRect BleedBox(SkPdfNativeDoc* doc);
  bool has_BleedBox() const;
  SkRect TrimBox(SkPdfNativeDoc* doc);
  bool has_TrimBox() const;
  SkRect ArtBox(SkPdfNativeDoc* doc);
  ...
  SkPdfStream* Thumb(SkPdfNativeDoc* doc);
  bool has_Thumb() const;
  SkPdfArray* B(SkPdfNativeDoc* doc);
  bool has_B() const;
  double Dur(SkPdfNativeDoc* doc);
  bool has_Dur() const;
  SkPdfDictionary* Trans(SkPdfNativeDoc* doc);
  ...
  bool has_ID() const;
  double PZ(SkPdfNativeDoc* doc);
  bool has_PZ() const;
  SkPdfDictionary* SeparationInfo(SkPdfNativeDoc* doc);
