...
public:
public:
   SkPdfThreadDictionary* asThreadDictionary() {return this;}
   const SkPdfThreadDictionary* asThreadDictionary() const {return this;}
...
public:
  ...
  bool has_F() const;
  SkPdfDictionary* I(SkPdfNativeDoc* doc);
  bool has_I() const;
};
