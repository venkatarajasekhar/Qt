...
public:
public:
   SkPdfPrinterMarkAnnotationDictionary* asPrinterMarkAnnotationDictionary() {return this;}
   const SkPdfPrinterMarkAnnotationDictionary* asPrinterMarkAnnotationDictionary() const {return this;}
...
public:
  ...
  SkString MN(SkPdfNativeDoc* doc);
  bool has_MN() const;
};
