...
public:
public:
   SkPdfType16HalftoneDictionary* asType16HalftoneDictionary() {return this;}
   const SkPdfType16HalftoneDictionary* asType16HalftoneDictionary() const {return this;}
...
public:
  ...
  int64_t Width2(SkPdfNativeDoc* doc);
