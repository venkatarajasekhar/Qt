...
public:
public:
   SkPdfTransparencyGroupDictionary* asTransparencyGroupDictionary() {return this;}
   const SkPdfTransparencyGroupDictionary* asTransparencyGroupDictionary() const {return this;}
...
public:
  ...
  bool has_CS() const;
  bool I(SkPdfNativeDoc* doc);
  bool has_I() const;
  bool K(SkPdfNativeDoc* doc);
  bool has_K() const;
};
