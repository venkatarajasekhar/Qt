...
public:
public:
   SkPdfGraphicsStateDictionary* asGraphicsStateDictionary() {return this;}
   const SkPdfGraphicsStateDictionary* asGraphicsStateDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  double LW(SkPdfNativeDoc* doc);
  bool has_LW() const;
  int64_t LC(SkPdfNativeDoc* doc);
  bool has_LC() const;
  int64_t LJ(SkPdfNativeDoc* doc);
  bool has_LJ() const;
  double ML(SkPdfNativeDoc* doc);
  bool has_ML() const;
  SkPdfArray* D(SkPdfNativeDoc* doc);
  bool has_D() const;
  SkString RI(SkPdfNativeDoc* doc);
  bool has_RI() const;
  bool OP(SkPdfNativeDoc* doc);
  bool has_OP() const;
  bool op(SkPdfNativeDoc* doc);
  bool has_op() const;
  int64_t OPM(SkPdfNativeDoc* doc);
  bool has_OPM() const;
  SkPdfArray* Font(SkPdfNativeDoc* doc);
  bool has_Font() const;
  ...
  bool has_HT() const;
  double FL(SkPdfNativeDoc* doc);
  bool has_FL() const;
  double SM(SkPdfNativeDoc* doc);
  bool has_SM() const;
  ...
  double CA(SkPdfNativeDoc* doc);
  bool has_CA() const;
  double ca(SkPdfNativeDoc* doc);
  bool has_ca() const;
  bool AIS(SkPdfNativeDoc* doc);
  bool has_AIS() const;
  bool TK(SkPdfNativeDoc* doc);
  bool has_TK() const;
};
