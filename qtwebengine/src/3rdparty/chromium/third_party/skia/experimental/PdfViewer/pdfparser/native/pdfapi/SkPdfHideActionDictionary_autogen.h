...
public:
public:
   SkPdfHideActionDictionary* asHideActionDictionary() {return this;}
   const SkPdfHideActionDictionary* asHideActionDictionary() const {return this;}
