...
public:
public:
   SkPdfObjectReferenceDictionary* asObjectReferenceDictionary() {return this;}
   const SkPdfObjectReferenceDictionary* asObjectReferenceDictionary() const {return this;}
...
public:
  ...
  bool has_Pg() const;
  SkPdfNativeObject* Obj(SkPdfNativeDoc* doc);
  bool has_Obj() const;
};
