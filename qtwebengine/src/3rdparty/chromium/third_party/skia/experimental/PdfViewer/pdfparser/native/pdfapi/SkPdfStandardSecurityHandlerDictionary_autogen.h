...
public:
public:
   SkPdfStandardSecurityHandlerDictionary* asStandardSecurityHandlerDictionary() {return this;}
   const SkPdfStandardSecurityHandlerDictionary* asStandardSecurityHandlerDictionary() const {return this;}
...
public:
  ...
  bool has_R() const;
  SkString O(SkPdfNativeDoc* doc);
  bool has_O() const;
  SkString U(SkPdfNativeDoc* doc);
  bool has_U() const;
  int64_t P(SkPdfNativeDoc* doc);
  bool has_P() const;
};
