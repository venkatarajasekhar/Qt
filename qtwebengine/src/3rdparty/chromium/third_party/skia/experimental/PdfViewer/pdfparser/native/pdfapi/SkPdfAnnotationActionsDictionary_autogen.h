...
public:
public:
   SkPdfAnnotationActionsDictionary* asAnnotationActionsDictionary() {return this;}
   const SkPdfAnnotationActionsDictionary* asAnnotationActionsDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* E(SkPdfNativeDoc* doc);
  bool has_E() const;
  SkPdfDictionary* X(SkPdfNativeDoc* doc);
  bool has_X() const;
  SkPdfDictionary* D(SkPdfNativeDoc* doc);
  bool has_D() const;
  SkPdfDictionary* U(SkPdfNativeDoc* doc);
  bool has_U() const;
  SkPdfDictionary* Fo(SkPdfNativeDoc* doc);
  bool has_Fo() const;
  SkPdfDictionary* Bl(SkPdfNativeDoc* doc);
  bool has_Bl() const;
};
