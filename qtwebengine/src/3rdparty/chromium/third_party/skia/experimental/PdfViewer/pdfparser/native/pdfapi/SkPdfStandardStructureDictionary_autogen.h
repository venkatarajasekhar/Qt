...
public:
public:
   SkPdfStandardStructureDictionary* asStandardStructureDictionary() {return this;}
   const SkPdfStandardStructureDictionary* asStandardStructureDictionary() const {return this;}
...
public:
  ...
  SkString Placement(SkPdfNativeDoc* doc);
  bool has_Placement() const;
  SkString WritingMode(SkPdfNativeDoc* doc);
