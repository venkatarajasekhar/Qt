...
public:
public:
   SkPdfCIDFontDictionary* asCIDFontDictionary() {return this;}
   const SkPdfCIDFontDictionary* asCIDFontDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* CIDSystemInfo(SkPdfNativeDoc* doc);
  bool has_CIDSystemInfo() const;
  SkPdfFontDescriptorDictionary* FontDescriptor(SkPdfNativeDoc* doc);
  bool has_FontDescriptor() const;
  int64_t DW(SkPdfNativeDoc* doc);
  bool has_DW() const;
  SkPdfArray* W(SkPdfNativeDoc* doc);
  bool has_W() const;
  SkPdfArray* DW2(SkPdfNativeDoc* doc);
  bool has_DW2() const;
