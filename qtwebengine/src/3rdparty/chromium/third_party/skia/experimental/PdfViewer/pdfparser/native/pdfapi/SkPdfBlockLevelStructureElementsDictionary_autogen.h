...
public:
public:
   SkPdfBlockLevelStructureElementsDictionary* asBlockLevelStructureElementsDictionary() {return this;}
   const SkPdfBlockLevelStructureElementsDictionary* asBlockLevelStructureElementsDictionary() const {return this;}
...
public:
  ...
  double SpaceBefore(SkPdfNativeDoc* doc);
  bool has_SpaceBefore() const;
  double SpaceAfter(SkPdfNativeDoc* doc);
  bool has_SpaceAfter() const;
  double StartIndent(SkPdfNativeDoc* doc);
  bool has_StartIndent() const;
  double EndIndent(SkPdfNativeDoc* doc);
  bool has_EndIndent() const;
  double TextIndent(SkPdfNativeDoc* doc);
  bool has_TextIndent() const;
  SkString TextAlign(SkPdfNativeDoc* doc);
  ...
  SkString BlockAlign(SkPdfNativeDoc* doc);
  bool has_BlockAlign() const;
  SkString InlineAlign(SkPdfNativeDoc* doc);
