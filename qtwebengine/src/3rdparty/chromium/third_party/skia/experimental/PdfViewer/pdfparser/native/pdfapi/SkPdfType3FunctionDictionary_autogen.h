...
public:
public:
   SkPdfType3FunctionDictionary* asType3FunctionDictionary() {return this;}
   const SkPdfType3FunctionDictionary* asType3FunctionDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Functions(SkPdfNativeDoc* doc);
  bool has_Functions() const;
  SkPdfArray* Bounds(SkPdfNativeDoc* doc);
