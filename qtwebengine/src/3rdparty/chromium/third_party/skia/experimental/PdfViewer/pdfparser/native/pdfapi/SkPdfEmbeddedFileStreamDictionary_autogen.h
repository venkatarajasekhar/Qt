...
public:
public:
   SkPdfEmbeddedFileStreamDictionary* asEmbeddedFileStreamDictionary() {return this;}
   const SkPdfEmbeddedFileStreamDictionary* asEmbeddedFileStreamDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* Params(SkPdfNativeDoc* doc);
