...
public:
public:
   SkPdfArtifactsDictionary* asArtifactsDictionary() {return this;}
   const SkPdfArtifactsDictionary* asArtifactsDictionary() const {return this;}
...
public:
  ...
  bool has_BBox() const;
  SkPdfArray* Attached(SkPdfNativeDoc* doc);
