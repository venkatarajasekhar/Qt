...
public:
public:
   SkPdfPagePieceDictionary* asPagePieceDictionary() {return this;}
   const SkPdfPagePieceDictionary* asPagePieceDictionary() const {return this;}
...
/*
  SkPdfDictionary* [any_application_name_or_well_known_data_type](SkPdfNativeDoc* doc);
