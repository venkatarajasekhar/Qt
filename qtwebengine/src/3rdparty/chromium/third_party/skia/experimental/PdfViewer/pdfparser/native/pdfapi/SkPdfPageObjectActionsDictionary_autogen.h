...
public:
public:
   SkPdfPageObjectActionsDictionary* asPageObjectActionsDictionary() {return this;}
   const SkPdfPageObjectActionsDictionary* asPageObjectActionsDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* O(SkPdfNativeDoc* doc);
  bool has_O() const;
