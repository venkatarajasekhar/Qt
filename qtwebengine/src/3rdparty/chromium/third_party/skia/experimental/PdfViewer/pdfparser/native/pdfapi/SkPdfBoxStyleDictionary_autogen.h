...
public:
public:
   SkPdfBoxStyleDictionary* asBoxStyleDictionary() {return this;}
   const SkPdfBoxStyleDictionary* asBoxStyleDictionary() const {return this;}
