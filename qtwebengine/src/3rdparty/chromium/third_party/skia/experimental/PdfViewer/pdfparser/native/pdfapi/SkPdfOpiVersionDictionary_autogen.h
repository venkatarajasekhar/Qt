...
public:
public:
   SkPdfOpiVersionDictionary* asOpiVersionDictionary() {return this;}
   const SkPdfOpiVersionDictionary* asOpiVersionDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* version_number(SkPdfNativeDoc* doc);
