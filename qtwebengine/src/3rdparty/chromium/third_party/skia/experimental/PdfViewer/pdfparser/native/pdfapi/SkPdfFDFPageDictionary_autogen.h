...
public:
public:
   SkPdfFDFPageDictionary* asFDFPageDictionary() {return this;}
   const SkPdfFDFPageDictionary* asFDFPageDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Templates(SkPdfNativeDoc* doc);
