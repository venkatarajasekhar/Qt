...
public:
public:
   SkPdfFDFTemplateDictionary* asFDFTemplateDictionary() {return this;}
   const SkPdfFDFTemplateDictionary* asFDFTemplateDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* TRef(SkPdfNativeDoc* doc);
  bool has_TRef() const;
  SkPdfArray* Fields(SkPdfNativeDoc* doc);
  bool has_Fields() const;
  bool Rename(SkPdfNativeDoc* doc);
