...
public:
public:
   SkPdfTableAttributesDictionary* asTableAttributesDictionary() {return this;}
   const SkPdfTableAttributesDictionary* asTableAttributesDictionary() const {return this;}
...
public:
  ...
  int64_t RowSpan(SkPdfNativeDoc* doc);
  bool has_RowSpan() const;
  int64_t ColSpan(SkPdfNativeDoc* doc);
