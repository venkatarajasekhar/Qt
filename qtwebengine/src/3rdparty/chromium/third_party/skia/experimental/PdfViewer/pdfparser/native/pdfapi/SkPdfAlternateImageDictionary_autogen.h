...
public:
public:
   SkPdfAlternateImageDictionary* asAlternateImageDictionary() {return this;}
   const SkPdfAlternateImageDictionary* asAlternateImageDictionary() const {return this;}
...
public:
  ...
  SkPdfStream* Image(SkPdfNativeDoc* doc);
  bool has_Image() const;
  bool DefaultForPrinting(SkPdfNativeDoc* doc);
