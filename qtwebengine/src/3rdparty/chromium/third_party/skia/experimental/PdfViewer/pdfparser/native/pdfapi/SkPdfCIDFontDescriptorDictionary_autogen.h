...
public:
public:
   SkPdfCIDFontDescriptorDictionary* asCIDFontDescriptorDictionary() {return this;}
   const SkPdfCIDFontDescriptorDictionary* asCIDFontDescriptorDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* Style(SkPdfNativeDoc* doc);
  bool has_Style() const;
  SkString Lang(SkPdfNativeDoc* doc);
  bool has_Lang() const;
  SkPdfDictionary* FD(SkPdfNativeDoc* doc);
  bool has_FD() const;
  SkPdfStream* CIDSet(SkPdfNativeDoc* doc);
