...
public:
public:
   SkPdfLineAnnotationDictionary* asLineAnnotationDictionary() {return this;}
   const SkPdfLineAnnotationDictionary* asLineAnnotationDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* L(SkPdfNativeDoc* doc);
  bool has_L() const;
  SkPdfDictionary* BS(SkPdfNativeDoc* doc);
  bool has_BS() const;
  SkPdfArray* LE(SkPdfNativeDoc* doc);
  bool has_LE() const;
  SkPdfArray* IC(SkPdfNativeDoc* doc);
  bool has_IC() const;
};
