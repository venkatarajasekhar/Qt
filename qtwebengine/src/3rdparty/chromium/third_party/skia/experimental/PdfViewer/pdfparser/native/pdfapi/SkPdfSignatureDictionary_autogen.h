...
public:
public:
   SkPdfSignatureDictionary* asSignatureDictionary() {return this;}
   const SkPdfSignatureDictionary* asSignatureDictionary() const {return this;}
...
public:
  ...
  bool has_Type() const;
  SkString Filter(SkPdfNativeDoc* doc);
  bool has_Filter() const;
  SkString SubFilter(SkPdfNativeDoc* doc);
  bool has_SubFilter() const;
  SkPdfArray* ByteRange(SkPdfNativeDoc* doc);
  bool has_ByteRange() const;
  SkString Contents(SkPdfNativeDoc* doc);
  bool has_Contents() const;
  SkString Name(SkPdfNativeDoc* doc);
  bool has_Name() const;
  SkPdfDate M(SkPdfNativeDoc* doc);
  bool has_M() const;
  SkString Location(SkPdfNativeDoc* doc);
  bool has_Location() const;
  SkString Reason(SkPdfNativeDoc* doc);
