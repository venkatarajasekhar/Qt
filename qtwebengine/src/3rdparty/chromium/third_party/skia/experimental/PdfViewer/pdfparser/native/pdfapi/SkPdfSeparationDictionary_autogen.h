...
public:
public:
   SkPdfSeparationDictionary* asSeparationDictionary() {return this;}
   const SkPdfSeparationDictionary* asSeparationDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* ColorSpace(SkPdfNativeDoc* doc);
