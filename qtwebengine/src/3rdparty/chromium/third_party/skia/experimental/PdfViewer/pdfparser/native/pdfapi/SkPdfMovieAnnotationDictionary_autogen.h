...
public:
public:
   SkPdfMovieAnnotationDictionary* asMovieAnnotationDictionary() {return this;}
   const SkPdfMovieAnnotationDictionary* asMovieAnnotationDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* Movie(SkPdfNativeDoc* doc);
