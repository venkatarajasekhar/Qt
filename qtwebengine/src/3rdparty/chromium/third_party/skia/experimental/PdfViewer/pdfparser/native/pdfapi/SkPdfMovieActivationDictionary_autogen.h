...
public:
public:
   SkPdfMovieActivationDictionary* asMovieActivationDictionary() {return this;}
   const SkPdfMovieActivationDictionary* asMovieActivationDictionary() const {return this;}
...
public:
  ...
  SkPdfNativeObject* Start(SkPdfNativeDoc* doc);
  bool has_Start() const;
  SkPdfNativeObject* Duration(SkPdfNativeDoc* doc);
  bool has_Duration() const;
  double Rate(SkPdfNativeDoc* doc);
  bool has_Rate() const;
  double Volume(SkPdfNativeDoc* doc);
  bool has_Volume() const;
  bool ShowControls(SkPdfNativeDoc* doc);
  bool has_ShowControls() const;
  SkString Mode(SkPdfNativeDoc* doc);
  bool has_Mode() const;
  bool Synchronous(SkPdfNativeDoc* doc);
  bool has_Synchronous() const;
  SkPdfArray* FWScale(SkPdfNativeDoc* doc);
  bool has_FWScale() const;
  SkPdfArray* FWPosition(SkPdfNativeDoc* doc);
