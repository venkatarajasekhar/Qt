...
public:
public:
   SkPdfInkAnnotationDictionary* asInkAnnotationDictionary() {return this;}
   const SkPdfInkAnnotationDictionary* asInkAnnotationDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* InkList(SkPdfNativeDoc* doc);
