...
public:
public:
   SkPdfSoundActionDictionary* asSoundActionDictionary() {return this;}
   const SkPdfSoundActionDictionary* asSoundActionDictionary() const {return this;}
