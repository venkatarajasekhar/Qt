...
public:
public:
   SkPdfPrinterMarkFormDictionary* asPrinterMarkFormDictionary() {return this;}
   const SkPdfPrinterMarkFormDictionary* asPrinterMarkFormDictionary() const {return this;}
...
public:
  ...
  SkString MarkStyle(SkPdfNativeDoc* doc);
  bool has_MarkStyle() const;
  SkPdfDictionary* Colorants(SkPdfNativeDoc* doc);
