...
public:
public:
   SkPdfDocumentInformationDictionary* asDocumentInformationDictionary() {return this;}
   const SkPdfDocumentInformationDictionary* asDocumentInformationDictionary() const {return this;}
...
public:
  ...
  SkString Title(SkPdfNativeDoc* doc);
  bool has_Title() const;
  SkString Author(SkPdfNativeDoc* doc);
  bool has_Author() const;
  SkString Subject(SkPdfNativeDoc* doc);
  bool has_Subject() const;
  SkString Keywords(SkPdfNativeDoc* doc);
  bool has_Keywords() const;
  SkString Creator(SkPdfNativeDoc* doc);
  bool has_Creator() const;
  SkString Producer(SkPdfNativeDoc* doc);
  bool has_Producer() const;
  SkPdfDate CreationDate(SkPdfNativeDoc* doc);
  bool has_CreationDate() const;
  SkPdfDate ModDate(SkPdfNativeDoc* doc);
  bool has_ModDate() const;
  SkString Trapped(SkPdfNativeDoc* doc);
