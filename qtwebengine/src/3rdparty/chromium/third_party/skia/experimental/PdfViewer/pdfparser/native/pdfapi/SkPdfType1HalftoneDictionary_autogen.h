...
public:
public:
   SkPdfType1HalftoneDictionary* asType1HalftoneDictionary() {return this;}
   const SkPdfType1HalftoneDictionary* asType1HalftoneDictionary() const {return this;}
...
public:
  ...
  double Frequency(SkPdfNativeDoc* doc);
