...
public:
public:
   SkPdfSoftMaskDictionary* asSoftMaskDictionary() {return this;}
   const SkPdfSoftMaskDictionary* asSoftMaskDictionary() const {return this;}
...
public:
  ...
  bool has_S() const;
  SkPdfStream* G(SkPdfNativeDoc* doc);
  bool has_G() const;
