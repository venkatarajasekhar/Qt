...
public:
public:
   SkPdfFileAttachmentAnnotationDictionary* asFileAttachmentAnnotationDictionary() {return this;}
   const SkPdfFileAttachmentAnnotationDictionary* asFileAttachmentAnnotationDictionary() const {return this;}
...
public:
  ...
  SkPdfFileSpec FS(SkPdfNativeDoc* doc);
  bool has_FS() const;
