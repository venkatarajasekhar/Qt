...
public:
public:
   SkPdfWidgetAnnotationDictionary* asWidgetAnnotationDictionary() {return this;}
   const SkPdfWidgetAnnotationDictionary* asWidgetAnnotationDictionary() const {return this;}
...
public:
  ...
  bool has_H() const;
  SkPdfDictionary* MK(SkPdfNativeDoc* doc);
  bool has_MK() const;
};
