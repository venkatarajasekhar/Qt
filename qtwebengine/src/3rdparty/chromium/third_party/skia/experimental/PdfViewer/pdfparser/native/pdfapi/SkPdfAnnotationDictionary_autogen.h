...
public:
public:
   SkPdfAnnotationDictionary* asAnnotationDictionary() {return this;}
   const SkPdfAnnotationDictionary* asAnnotationDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* P(SkPdfNativeDoc* doc);
  bool has_P() const;
  ...
  bool has_F() const;
  SkPdfDictionary* BS(SkPdfNativeDoc* doc);
  bool has_BS() const;
  SkPdfArray* Border(SkPdfNativeDoc* doc);
  bool has_Border() const;
  SkPdfDictionary* AP(SkPdfNativeDoc* doc);
  bool has_AP() const;
  SkString AS(SkPdfNativeDoc* doc);
  bool has_AS() const;
  SkPdfArray* C(SkPdfNativeDoc* doc);
  bool has_C() const;
  double CA(SkPdfNativeDoc* doc);
  bool has_CA() const;
  SkString T(SkPdfNativeDoc* doc);
  bool has_T() const;
  SkPdfDictionary* Popup(SkPdfNativeDoc* doc);
