...
public:
public:
   SkPdfResourceDictionary* asResourceDictionary() {return this;}
   const SkPdfResourceDictionary* asResourceDictionary() const {return this;}
...
public:
  ...
  SkPdfDictionary* ExtGState(SkPdfNativeDoc* doc);
  bool has_ExtGState() const;
  SkPdfDictionary* ColorSpace(SkPdfNativeDoc* doc);
  bool has_ColorSpace() const;
  SkPdfDictionary* Pattern(SkPdfNativeDoc* doc);
  bool has_Pattern() const;
  SkPdfDictionary* Shading(SkPdfNativeDoc* doc);
  bool has_Shading() const;
  SkPdfDictionary* XObject(SkPdfNativeDoc* doc);
  bool has_XObject() const;
  SkPdfDictionary* Font(SkPdfNativeDoc* doc);
  bool has_Font() const;
  SkPdfArray* ProcSet(SkPdfNativeDoc* doc);
  bool has_ProcSet() const;
  SkPdfDictionary* Properties(SkPdfNativeDoc* doc);
