...
public:
public:
   SkPdfType2PatternDictionary* asType2PatternDictionary() {return this;}
   const SkPdfType2PatternDictionary* asType2PatternDictionary() const {return this;}
...
public:
  ...
  int64_t Type(SkPdfNativeDoc* doc);
  bool has_Type() const;
