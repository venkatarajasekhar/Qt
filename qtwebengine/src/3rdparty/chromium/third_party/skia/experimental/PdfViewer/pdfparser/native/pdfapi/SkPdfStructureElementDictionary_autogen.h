...
public:
public:
   SkPdfStructureElementDictionary* asStructureElementDictionary() {return this;}
   const SkPdfStructureElementDictionary* asStructureElementDictionary() const {return this;}
...
public:
  ...
  bool has_ID() const;
  SkPdfDictionary* Pg(SkPdfNativeDoc* doc);
  bool has_Pg() const;
  SkPdfNativeObject* K(SkPdfNativeDoc* doc);
  bool has_K() const;
  ...
  bool has_Lang() const;
  SkString Alt(SkPdfNativeDoc* doc);
  bool has_Alt() const;
  SkString ActualText(SkPdfNativeDoc* doc);
