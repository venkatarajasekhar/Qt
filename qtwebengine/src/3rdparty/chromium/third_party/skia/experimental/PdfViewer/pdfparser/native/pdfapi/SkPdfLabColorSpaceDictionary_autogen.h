...
public:
public:
   SkPdfLabColorSpaceDictionary* asLabColorSpaceDictionary() {return this;}
   const SkPdfLabColorSpaceDictionary* asLabColorSpaceDictionary() const {return this;}
...
public:
  ...
  SkPdfArray* Range(SkPdfNativeDoc* doc);
