...
public:
public:
   SkPdfLaunchActionDictionary* asLaunchActionDictionary() {return this;}
   const SkPdfLaunchActionDictionary* asLaunchActionDictionary() const {return this;}
...
public:
  ...
  bool has_F() const;
  SkPdfDictionary* Win(SkPdfNativeDoc* doc);
  bool has_Win() const;
  SkPdfNativeObject* Mac(SkPdfNativeDoc* doc);
  bool has_Mac() const;
  SkPdfNativeObject* Unix(SkPdfNativeDoc* doc);
  bool has_Unix() const;
  bool NewWindow(SkPdfNativeDoc* doc);
