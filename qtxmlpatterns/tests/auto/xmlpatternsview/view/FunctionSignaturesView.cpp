    ...
    : QDockWidget(QLatin1String("Function Signatures View"), p)
{
    ...
    signatureList->addItems(DebugExpressionFactory::availableFunctionSignatures());
    signatureList->sortItems();
    countInfo->setText(QString::fromLatin1("Count: %1").arg(signatureList->count()));
}
